...
class ProgressBar(object):
    ...
    def __init__(self, mode,epoch=None,
                 total_epoch=None,
                 current_loss=None,
                 current_top1=None,
                 model_name=None,
    ...
    def __call__(self):
        ...
        message = "\033[1;32;40m%(mode)s Epoch:  %(epoch)d/%(epochs)d %(bar)s" \
                  "\033[0m  [Current: Loss %(current_loss)f Top1: %(current_top1)f ]  " \
                  "%(current)d/%(total)d \033[1;32;40m[ %(percent)3d%% ]\033[0m" %args
        self.write_message = "%(mode)s Epoch:  %(epoch)d/%(epochs)d %(bar)s " \
                             " [Current: Loss %(current_loss)f Top1: %(current_top1)f ] " \
